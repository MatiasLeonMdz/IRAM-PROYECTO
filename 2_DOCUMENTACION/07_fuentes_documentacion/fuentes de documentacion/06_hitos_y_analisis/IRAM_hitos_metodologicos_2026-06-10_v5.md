...
**Generado:** 2026-06-10 15:42 | **Actualizado:** 2026-06-10 (sesión v5 — fusión v3.1 + v4)
**Fuente:** Historial unificado 7448 msgs (5 Claudes) + TECHNICAL_WIKI_ACTIVE v3.10 + TECHNICAL_WIKI_ARCHIVE v3.7 + zip v5.5
...
**Sesión v5 (esta):** Fusión v3.1 + v4 — documento definitivo. Se incorporan: marco 5D completo, sección fuentes, tabla transiciones, hallazgos nuevos de v3.1, evidencia extendida; se incorporan: hitos período v5, mapa versiones v1→v5.5, de v4.
...
**Estado:** ⚠️ REQUIERE DEFINICIÓN — depende de qué capa se toma como "primera wiki"
...
| Nombre "TECHNICAL_WIKI" adoptado | 2026-05-27 (CLAUDE_3) | Usuario preguntó "TECHNICAL_WIKI supongo que nombre es el mas comun para este tipo de documento" |
...
**Recomendación:** Definir "primera_wiki" como primer documento de referencia técnica del proyecto → **2026-04-17 (CLAUDE_2), `exodus_backup_tecnico_v5.md`**
...
**Estado:** ⚠️ FECHA NO VERIFICADA — práctica confirmada por el operador (2026-06-10)
...
**Evidencia a buscar en conversations.json:**
...
- Qué reglas del PROMPT_MAESTRO tienen evidencia de haber nacido de un bug específico
...
**Fecha:** 2026-05-27 (CLAUDE_3 o CLAUDE_4 — ⚠️ cuenta exacta pendiente de verificar)
**Estado:** ✅ CONFIRMADO — evidencia directa en ARCHIVE v3.7, Sección 19
