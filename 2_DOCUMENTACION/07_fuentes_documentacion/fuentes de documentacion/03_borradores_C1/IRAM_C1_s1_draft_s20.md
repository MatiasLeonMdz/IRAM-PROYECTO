...
IRAM es un mod para Imperator: Rome 2.0.4 — un juego de estrategia histórica ambientado en la antigüedad clásica. Un mod modifica el comportamiento del juego: en este caso, automatiza decisiones económicas y demográficas que el juego original deja al jugador. El mod se construyó en aproximadamente dos meses, en 441 conversaciones con IA, a través de 5 cuentas de Claude, acumulando 7345 mensajes analizados.
...
*Sección 1 — draft s20 — 2026-06-17 16:16*
