# PROMPT — SISTEMA DE DOCUMENTACIÓN IRAM v1.7
...
SECUENCIA DE TRABAJO (orden correcto — no saltear pasos)
  ...
  Plantilla B → análisis de gaps                    ⚠️ PENDIENTE
...
Plantilla B:         ⚠️ PENDIENTE
Plantilla C:         ❌ PENDIENTE — requiere Plantilla B
```
...
9. Rotación de contextos — cómo gestionar múltiples contextos en rotación secuencial
...
NOTA: Bloques 3, 4, 5 no bloquean Plantilla C.
...
*PROMPT DOCUMENTACIÓN IRAM v1.7 — 2026-06-12*
