# PROMPT MAESTRO — IRAM v3.9
## Para usar al inicio de cada sesión en Claude

*Actualizado: 2026-05-30 03:14 | Para instrucciones de carga ver: IRAM_INSTRUCCIONES_HUMANO (ver Sección 22 del TECHNICAL_WIKI ACTIVE)*
...
(IRAM v1 → v2 → v3) contra el estado actual (IRAM v4.3.16), usando como fuentes:
...
*IRAM PROMPT MAESTRO v3.9 — 2026-05-30 03:14*
*Cambios v3.9:*
*- R19 agregada al bloque 🔴 CRÍTICAS: confirmar antes de modificar cualquier archivo.*
*- Versión del mod actualizada a v4.3.16 en PLANTILLA B.*
*Motivación: R19 existía en Plantilla A como protocolo de trabajo pero sin número ni color —*
*la IA la trataba como contexto, no como regla operativa. Documentado en sesión 2026-05-30 03:14.*
