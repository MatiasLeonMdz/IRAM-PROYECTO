# WIKI — Documentación IRAM v3.0
## Contexto histórico y estado de todos los documentos

*Actualizado: 2026-07-07 | Adjuntar en cada sesión — no pegar*
*Versión anterior: WIKI_DOCUMENTACION_v2.md (2026-06-17, s30)*
...
(Corregido 2026-07-07. Reemplaza el principio de "democratización" — nunca actualizado en esta wiki pese a que la Corrección 1 del 17/06 05:43 ya lo había descartado en el paper mismo. Cadena de origen completa: DR-22. Fuente del texto: `IRAM_C1_final.md`, Sección 3. Nota: esta misma wiki es evidencia del principio que enuncia — la corrección de Sección 3 ya estaba aplicada en el draft desde el 17/06 [ver tabla ESTADO DE TODOS LOS DOCUMENTOS, fila `IRAM_C1_s3_draft`], pero el resumen "PRINCIPIO CENTRAL" de esta página, por estar en una posición distinta del documento, nunca heredó el cambio. La discrepancia no fue de contenido — el contenido correcto existía — fue de posición.)
...
| WIKI_DOCUMENTACION_v1.md | Reemplazado por WIKI_DOCUMENTACION_v2.md |
| WIKI_DOCUMENTACION_v2.md | Reemplazado por este archivo — PRINCIPIO CENTRAL corregido (DC-06/DR-22) |

---

*WIKI DOCUMENTACIÓN v3.0 — 2026-07-07*
*Correcciones respecto a v2: PRINCIPIO CENTRAL DEL PAPER reemplazado — "la IA no democratiza la programación" (nunca actualizado desde 2026-06-17 pese a estar descartado en el paper desde esa misma fecha) por "la posición y el formato importan tanto como el contenido", tomado textualmente de la Sección 3 vigente de `IRAM_C1_final.md`. Corrección aplicada por decisión DC-06, cadena de origen DR-22, resuelta en debate del Paquete A (consolidación FUENTE_DE_VERDAD, sesión 2026-07-07). Bloqueo DR-12 tratado como excepción puntual, no como derogación general: DR-12 sigue vigente para el resto de esta wiki, que continúa esperando la base de hechos del análisis A/B antes de cualquier otra revisión.*
*Correcciones heredadas de v1→v2, sin cambios: pie actualizado a s29; Marco Conceptual 13 clusters completo; tabla SECUENCIA DE TRABAJO actualizada (todas las secciones del paper ✅); METODOLOGIA_DOCUMENTACION_v1.md agregada a tabla de documentos; DEC-03 sesión de origen corregida a s22.*
*Decisiones ejecutables en SESSION_LOG_DOCUMENTACION_s30.md (heredado) y en FUENTE_DE_VERDAD_IRAM_2026-07-07_3.md §10 (nuevo).*
