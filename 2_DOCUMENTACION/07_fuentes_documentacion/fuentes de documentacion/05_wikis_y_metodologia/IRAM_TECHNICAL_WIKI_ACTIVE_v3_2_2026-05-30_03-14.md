...
| Última sesión | 2026-05-30 03:14 |
...
| **Optimize Global** | 🔧 STUB CORREGIDO — on_action pendiente | `mod_pack_IRAM_v4_3_16_2026-05-30_03-14.zip` | on_action (5 bloques/pulso, rangos auto), guards, cleanup — ver Sección 19.0 |
...
| BUG A — `exodos.2` nombre incorrecto para DG | Decía "Optimize Global" pero era disparado también por DG | ✅ CORREGIDO v4.3.16 |
| BUG B — GG sin notificación de completado | GG terminaba silenciosamente sin disparar evento al jugador | ✅ CORREGIDO v4.3.16 |
| BUG C — GG segunda ejecución rota | GG no llamaba a `exodos_cleanup_effect` al terminar — `exodos_gather_global_done` persistía en todas las provincias | ✅ CORREGIDO v4.3.16 |
...
|---|---|---|---|
| Optimize Global — implementación on_action | ⚠️ PENDIENTE | Única función mayor que falta para cerrar v4 | 2026-05-26 20:49 |
| Distribute Global (`iram_11`) — implementación on_action | ⚠️ PENDIENTE | Función nueva, diseño cerrado | 2026-05-26 20:49 |
| Constructor Automático (`iram_12`) — codear decisión + locs | ⚠️ PENDIENTE | Diseño CERRADO 15:12, listo para codear | 2026-05-27 15:12 |
| Refactor zip — nueva numeración iram_01–iram_25 | ⚠️ PENDIENTE | Sin refactor el zip tiene árbol viejo y variables viejas | 2026-05-26 20:49 |
| 3 variables nuevas en `exodos_cleanup_effect` | ⚠️ PENDIENTE | Variables de funciones nuevas no se limpian con cancel_all | 2026-05-26 20:49 |
| Calibración números Distribute Global (5/10/15) | ⚠️ PENDIENTE — post-testeo | Valores provisorios | 2026-05-26 20:49 |
| Fix Gather legacy (`exodos_gather_active`) — guard ciudades secundarias | ⚠️ PENDIENTE | Mismo bug corregido en GG, falta en Gather por área | 2026-05-29 05:49 |
...
| Git — commit inicial | ⚠️ PENDIENTE POST-CIERRE | Sin Git el versionado depende de zips | 2026-05-27 20:06 |
...
| `mod_pack_IRAM_v4_3_7_2026-05-27_17-14.zip` | ídem | 27/5 17:14 | 🗃 HISTÓRICO | 5 bugs corregidos: BOM doble, llaves desbalanceadas ×2, scope popularity, nombre variable cleanup_menu |
| `mod_pack_IRAM_v4_3_11_2026-05-29_05-49.zip` | ídem | 29/5 05:49 | 🗃 HISTÓRICO | Fix ciudades secundarias en GG (guard city/metropolis en 10 bloques), textos iram_10/11/12/13 |
| `mod_pack_IRAM_v4_3_15_2026-05-29_23-02.zip` | ídem | 29/5 23:02 | 🗃 HISTÓRICO | Costos eliminados para test |
| `mod_pack_IRAM_v4_3_16_2026-05-30_03-14.zip` ✅ **CANÓNICO** | ídem | 30/5 03:14 | ✅ ACTIVO | BUG A/B/C eventos GG/DG/OG: exodos.2→DG, exodos.3→OG (nuevo), exodos.4→GG (nuevo), cleanup GG corregido |
...
|---|---|---|
| TECHNICAL_WIKI (ACTIVE) | `IRAM_TECHNICAL_WIKI_ACTIVE_v3_1_2026-05-29_16-17.md` | v3.1 |
