...
### Engine: Imperator Roma 2.0.4 | Ironman compatible ✓ | mod_pack_IRAM.zip | v1.13 — ÚLTIMA VERSIÓN DE IRAM v3
...
| Versión IRAM | v1.13 |
| Fecha | 2026-05 |
| Estado | **CERRADO — IRAM v3 FINALIZADO.** Optimizar implementado, rangos refinados v1.13, Distribute corregido, Rival Heir v1.6 implementado. BOM de `exodos_decisions_optimize.txt` corregido. **ÚLTIMA VERSIÓN EN USO: mod_pack_IRAM_15.zip** |
...
- Las 11 decisiones de rango (exodos_opt_range_03 … exodos_opt_range_13) — máximo 200 pops
...
2. Usuario activa Optimizar
   ...
   → Aparecen las 11 decisiones de rango (exodos_opt_range_03 … exodos_opt_range_13)
...
3. Usuario elige el rango que corresponde a su total de pops
   ...
   (Nota: decisiones de rango disponibles solo hasta ~200 pops — _03 a _13)
...
**Límite máximo: ~200 pops. Las decisiones _14 a _19 fueron eliminadas en v1.12. — CERRADO**

| Decisión | Rango total | Count/asent | Título UI ES | Título UI EN |
|---|---|---|---|---|
| exodos_opt_range_03 | 45–58 | 3 | "Entre 45 y 58 pops en la provincia" | "Between 45 and 58 pops in the province" |
| exodos_opt_range_04 | 59–73 | 4 | "Entre 59 y 73 pops en la provincia" | "Between 59 and 73 pops in the province" |
| exodos_opt_range_05 | 74–88 | 5 | "Entre 74 y 88 pops en la provincia" | "Between 74 and 88 pops in the province" |
| exodos_opt_range_06 | 89–103 | 6 | "Entre 89 y 103 pops en la provincia" | "Between 89 and 103 pops in the province" |
| exodos_opt_range_07 | 104–117 | 7 | "Entre 104 y 117 pops en la provincia" | "Between 104 and 117 pops in the province" |
| exodos_opt_range_08 | 118–132 | 8 | "Entre 118 y 132 pops en la provincia" | "Between 118 and 132 pops in the province" |
| exodos_opt_range_09 | 133–147 | 9 | "Entre 133 y 147 pops en la provincia" | "Between 133 and 147 pops in the province" |
| exodos_opt_range_10 | 148–162 | 10 | "Entre 148 y 162 pops en la provincia" | "Between 148 and 162 pops in the province" |
| exodos_opt_range_11 | 163–177 | 11 | "Entre 163 y 177 pops en la provincia" | "Between 163 and 177 pops in the province" |
| exodos_opt_range_12 | 178–192 | 12 | "Entre 178 y 192 pops en la provincia" | "Between 178 and 192 pops in the province" |
...
8→9: 132/133 | 9→10: 147/148 | 10→11: 162/163 | 11→12: 177/178 | 12→13: 192/193 |
13→14: 209/210 (límite — _14 eliminada)

**Por qué estos valores son correctos — CERRADO v1.13:** los rangos v1.0–v1.10 se calcularon con scipy.brentq sin considerar que el
Gather deja 1 pop por asentamiento (corregido en v1.11). En v1.13 se refinó la frontera 11→12
usando la lógica completa de `calcOptimalDist` del optimizador v4 (con slots dinámicos y mercados
extra sobre `BAKED_MERCADOS=5`): el cruce correcto es 177/178, no 176/177. La diferencia en costo
en t=177 entre count=11 y count=12 es de 0.20 meses — ambos son correctos, el cruce es el preciso.
Verificado con búsqueda discreta exhaustiva para todos los totales 45–209.
Error máximo en cualquier total dentro de cada rango: ≤ 4.9 meses.
Progresión de anchos: 14–15 pops por rango (rangos 11 y 12 ganan 1 pop cada uno, compensados).
...
**exodos_opt_range_03 … exodos_opt_range_13 — título (patrón):**
`"Optimizar: Entre X y Y pops en la provincia"` (X e Y según tabla de rangos en sección 2.5)

**exodos_opt_range_03 … exodos_opt_range_13 — descripción (idéntica para todos los rangos):**
...
**Optimize fase Distribute:** `count = var:exodos_optimize_count` por destino. 1 solo pulso, sin piso de ancla. Siempre `exodos_cleanup_effect = yes` al final. 11 bloques `else_if` (count 3–13).
...
| Decisiones de rango aparecen SOLO después de activate | has_variable = exodos_optimize_pending | Evita saturar el panel con 11 botones permanentes |
...
Las 11 decisiones de rango están calibradas sobre los resultados del optimizador —
...
### v1.13 — 2026-05 — ÚLTIMA VERSIÓN DE IRAM v3
- **EXODOS: OPTIMIZAR — Refinamiento de frontera 11→12** — El cruce entre `exodos_opt_range_11` (count=11) y `exodos_opt_range_12` (count=12) fue recalculado usando la lógica completa de `calcOptimalDist` del optimizador v4, incluyendo slots dinámicos y la corrección `BAKED_MERCADOS=5` en `calcCityAssimPh2Spd`. El cruce correcto es 177/178 (antes 176/177). Rango 11 actualizado a 163–177, rango 12 a 178–192. La diferencia en costo en el punto de cruce (t=177) entre ambos counts es de 0.20 meses — la corrección es de precisión, no de funcionalidad.
- **BOM corregido en `exodos_decisions_optimize.txt`** — El archivo carecía de BOM UTF-8 en la versión anterior. Corregido en este build.
- **Archivos modificados:** `exodos/localization/spanish/exodos_l_spanish.yml` (2 títulos de rango — BOM también corregido), `exodos/localization/english/exodos_l_english.yml` (2 títulos de rango — BOM también corregido), `exodos/decisions/exodos_decisions_optimize.txt` (solo BOM). **Entregado como `mod_pack_IRAM_15.zip` — ÚLTIMA VERSIÓN EN USO. IRAM v3 CERRADO.**

### v1.12 — 2026-05
- **EXODOS: OPTIMIZAR — Eliminación de rangos altos** — Las decisiones `exodos_opt_range_14` a `exodos_opt_range_19` (rangos 210–300 pops) fueron eliminadas. El mod ahora soporta hasta ~200 pops máximo. La decisión más alta disponible es `_13` (193–209 pops, cruce en 209/210). Total de decisiones de rango: 11 (_03 a _13).
- **Archivos modificados:** `exodos/decisions/exodos_decisions_optimize.txt` (comentario de cabecera actualizado, bloques _14–_19 eliminados), `exodos/localization/spanish/exodos_l_spanish.yml` (12 líneas eliminadas), `exodos/localization/english/exodos_l_english.yml` (12 líneas eliminadas). BOM validado. Entregado como `mod_pack_IRAM_14.zip`.
...
*Imperator: Rome — Alternative Mechanics MOD PACK — Backup Técnico v1.13 — 2026-05*
*ÚLTIMA VERSIÓN DE IRAM v3 — Proyecto cerrado en esta versión.*
*Última versión en uso: mod_pack_IRAM_15.zip*
