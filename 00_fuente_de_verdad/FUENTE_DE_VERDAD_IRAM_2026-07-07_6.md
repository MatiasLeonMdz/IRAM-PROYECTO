...
| B | **Parcialmente cerrado, actualizado en sesión posterior.** Pregunta #4 resuelta con dato (ver §10, sesión 2026-07-07). Preguntas #1, #2 y #3 verificadas contra el ZIP completo y cerradas con matices en §13 (sesión posterior, mismo día) — ver §13 para el detalle completo, incluida una corrección al resumen de partida de esa sesión sobre la pregunta #2. |
